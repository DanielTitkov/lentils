...
func (stq *ScaleTranslationQuery) GroupBy(field string, fields ...string) *ScaleTranslationGroupBy {
	group := &ScaleTranslationGroupBy{config: stq.config}
...
func (stq *ScaleTranslationQuery) Select(fields ...string) *ScaleTranslationSelect {
	...
	return &ScaleTranslationSelect{ScaleTranslationQuery: stq}
}
...
func (stq *ScaleTranslationQuery) sqlAll(ctx context.Context) ([]*ScaleTranslation, error) {
	var (
...
func (stgb *ScaleTranslationGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (stgb *ScaleTranslationGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(stgb.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := stgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (stgb *ScaleTranslationGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (stgb *ScaleTranslationGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(stgb.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := stgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (stgb *ScaleTranslationGroupBy) IntsX(ctx context.Context) []int {
	v, err := stgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (stgb *ScaleTranslationGroupBy) IntX(ctx context.Context) int {
	v, err := stgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(stgb.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := stgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (stgb *ScaleTranslationGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (stgb *ScaleTranslationGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(stgb.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := stgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (stgb *ScaleTranslationGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (stgb *ScaleTranslationGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (stgb *ScaleTranslationGroupBy) BoolX(ctx context.Context) bool {
	v, err := stgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (sts *ScaleTranslationSelect) ScanX(ctx context.Context, v interface{}) {
...
func (sts *ScaleTranslationSelect) Strings(ctx context.Context) ([]string, error) {
	if len(sts.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := sts.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (sts *ScaleTranslationSelect) StringsX(ctx context.Context) []string {
...
func (sts *ScaleTranslationSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (sts *ScaleTranslationSelect) StringX(ctx context.Context) string {
...
func (sts *ScaleTranslationSelect) Ints(ctx context.Context) ([]int, error) {
	if len(sts.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := sts.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (sts *ScaleTranslationSelect) IntsX(ctx context.Context) []int {
	v, err := sts.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (sts *ScaleTranslationSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (sts *ScaleTranslationSelect) IntX(ctx context.Context) int {
	v, err := sts.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (sts *ScaleTranslationSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(sts.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := sts.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (sts *ScaleTranslationSelect) Float64sX(ctx context.Context) []float64 {
...
func (sts *ScaleTranslationSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (sts *ScaleTranslationSelect) Float64X(ctx context.Context) float64 {
...
func (sts *ScaleTranslationSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(sts.fields) > 1 {
		return nil, errors.New("ent: ScaleTranslationSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := sts.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (sts *ScaleTranslationSelect) BoolsX(ctx context.Context) []bool {
	v, err := sts.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (sts *ScaleTranslationSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{scaletranslation.Label}
	default:
		err = fmt.Errorf("ent: ScaleTranslationSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (sts *ScaleTranslationSelect) BoolX(ctx context.Context) bool {
	v, err := sts.Bool(ctx)
	if err != nil {
		panic(err)
	}
