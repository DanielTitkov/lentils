...
func (iu *ItemUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if iu.mutation.ScaleCleared() {
		...
		createE := &ScaleItemCreate{config: iu.config, mutation: newScaleItemMutation(iu.config, OpCreate)}
		createE.defaults()
...
func (iuo *ItemUpdateOne) sqlSave(ctx context.Context) (_node *Item, err error) {
	...
	if iuo.mutation.ScaleCleared() {
		...
		createE := &ScaleItemCreate{config: iuo.config, mutation: newScaleItemMutation(iuo.config, OpCreate)}
		createE.defaults()
		_, specE := createE.createSpec()
		edge.Target.Fields = specE.Fields
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
