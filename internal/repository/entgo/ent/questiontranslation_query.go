...
func (qtq *QuestionTranslationQuery) GroupBy(field string, fields ...string) *QuestionTranslationGroupBy {
	group := &QuestionTranslationGroupBy{config: qtq.config}
...
func (qtq *QuestionTranslationQuery) Select(fields ...string) *QuestionTranslationSelect {
	...
	return &QuestionTranslationSelect{QuestionTranslationQuery: qtq}
}
...
func (qtq *QuestionTranslationQuery) sqlAll(ctx context.Context) ([]*QuestionTranslation, error) {
	var (
...
func (qtgb *QuestionTranslationGroupBy) ScanX(ctx context.Context, v interface{}) {
	if err := qtgb.Scan(ctx, v); err != nil {
		panic(err)
	}
}
...
func (qtgb *QuestionTranslationGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(qtgb.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := qtgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (qtgb *QuestionTranslationGroupBy) StringsX(ctx context.Context) []string {
	v, err := qtgb.Strings(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	if v, err = qtgb.Strings(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (qtgb *QuestionTranslationGroupBy) StringX(ctx context.Context) string {
	v, err := qtgb.String(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(qtgb.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := qtgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (qtgb *QuestionTranslationGroupBy) IntsX(ctx context.Context) []int {
	v, err := qtgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	if v, err = qtgb.Ints(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (qtgb *QuestionTranslationGroupBy) IntX(ctx context.Context) int {
	v, err := qtgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(qtgb.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := qtgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (qtgb *QuestionTranslationGroupBy) Float64sX(ctx context.Context) []float64 {
	v, err := qtgb.Float64s(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	if v, err = qtgb.Float64s(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (qtgb *QuestionTranslationGroupBy) Float64X(ctx context.Context) float64 {
	v, err := qtgb.Float64(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(qtgb.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := qtgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (qtgb *QuestionTranslationGroupBy) BoolsX(ctx context.Context) []bool {
	v, err := qtgb.Bools(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (qtgb *QuestionTranslationGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	if v, err = qtgb.Bools(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (qtgb *QuestionTranslationGroupBy) BoolX(ctx context.Context) bool {
	v, err := qtgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (qts *QuestionTranslationSelect) ScanX(ctx context.Context, v interface{}) {
	if err := qts.Scan(ctx, v); err != nil {
		panic(err)
	}
}

// Strings returns list of strings from a selector. It is only allowed when selecting one field.
func (qts *QuestionTranslationSelect) Strings(ctx context.Context) ([]string, error) {
	if len(qts.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := qts.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (qts *QuestionTranslationSelect) StringsX(ctx context.Context) []string {
	v, err := qts.Strings(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (qts *QuestionTranslationSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	if v, err = qts.Strings(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (qts *QuestionTranslationSelect) StringX(ctx context.Context) string {
	v, err := qts.String(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (qts *QuestionTranslationSelect) Ints(ctx context.Context) ([]int, error) {
	if len(qts.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := qts.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (qts *QuestionTranslationSelect) IntsX(ctx context.Context) []int {
	v, err := qts.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (qts *QuestionTranslationSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	if v, err = qts.Ints(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (qts *QuestionTranslationSelect) IntX(ctx context.Context) int {
	v, err := qts.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (qts *QuestionTranslationSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(qts.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := qts.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (qts *QuestionTranslationSelect) Float64sX(ctx context.Context) []float64 {
	v, err := qts.Float64s(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (qts *QuestionTranslationSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	if v, err = qts.Float64s(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (qts *QuestionTranslationSelect) Float64X(ctx context.Context) float64 {
	v, err := qts.Float64(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (qts *QuestionTranslationSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(qts.fields) > 1 {
		return nil, errors.New("ent: QuestionTranslationSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := qts.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (qts *QuestionTranslationSelect) BoolsX(ctx context.Context) []bool {
	v, err := qts.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (qts *QuestionTranslationSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	if v, err = qts.Bools(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{questiontranslation.Label}
	default:
		err = fmt.Errorf("ent: QuestionTranslationSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (qts *QuestionTranslationSelect) BoolX(ctx context.Context) bool {
	v, err := qts.Bool(ctx)
	if err != nil {
		panic(err)
	}
